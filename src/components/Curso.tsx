...
export function Curso(){
    ...
    return(
        <section id="id-curso" className="w-ful h-auto flex justify-center">
            <div id="id-pj" 
                className='w-[1040px] h-auto text-slate-50 p-5 bg-bg-blue-900 relative lg:px-2' 
                >
                <h2 id="t-h2"
                        className="w-full text-400 text-center text-[25px] font-semibold pb-6"
                >
                        Cursos  & Formação
                </h2>
