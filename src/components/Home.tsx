...
export  function Home (){
    const [user, setUser] = useState<GitLink>({name:'', avatar:'',reposURL:''});
    ...
    return(
        <section id ="home" className="w-full h-auto flex justify-center ">
            <div id = "home-ct" 
                className="w-[1040px] h-auto p-5 rounded-xl 
                            flex items-center justify-between bg-bg-blue-900 
                            relative mt-20 lg:px-2 md:flex-col-reverse md:w-full sm:p-4"
            >
                <div id="home-wc" 
